...
var octoDeckAction    = {
    ...
    onKeyDown: function (context, settings, coordinates, userDesiredState) {
        console.log("onKeyDown context: ", context, " settings: ", settings);

        longPressTimeout = setTimeout(function() {
            octoDeckAction.OpenUrl(context, settings.octoUrl);
...
function connectElgatoStreamDeckSocket(inPort, inPluginUUID, inRegisterEvent, inInfo) {
    ...
    websocket.onmessage = function (evt) {
        ...
        if (event == "keyUp") {
            ...
            var coordinates = jsonPayload['coordinates'];
            var userDesiredState = jsonPayload['userDesiredState'];
            octoDeckAction.onKeyDown(context, settings, coordinates, userDesiredState);
        }
...
function getData(settings, context) {
    if (!settings.octoUrl || !settings.octoKey || !settings.octoInterval || !settings.octoBackground || !settings.longPressDelay) {
